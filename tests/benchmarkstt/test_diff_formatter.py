...
ansi_color_key = formatter.ANSIDiffDialect().color_key


@pytest.mark.parametrize('dialect,expected', [
    ['text', 'AB\u0359BCDEFG\u0338HH\u0359I\u0359JKLMN\u0338'],
    ['ansi', ansi_color_key + 'A\033[32mB\033[0mBCDEF\033[31mG\033[0mH\033[32mHI\033[0mJKLM\033[31mN\033[0m'],
...
def test_no_diff():
    assert formatter.format_diff(a, a, dialect='ansi') == (ansi_color_key + a)
